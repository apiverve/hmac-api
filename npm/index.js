...
class hmacWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/hmac');
        }
        ...
        this.validationRules = {"message":{"type":"string","required":true},"secret":{"type":"string","required":true},"algorithm":{"type":"string","required":false,"default":"sha256"},"encoding":{"type":"string","required":false,"default":"hex"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/hmac`);
        }
    }
