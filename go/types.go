...
// Request contains the parameters for the HMAC Generator API.
//
// Parameters:
...
type Request struct {
	...
	Algorithm string `json:"algorithm,omitempty"` // Optional
...
// ResponseData contains the data returned by the HMAC Generator API.
