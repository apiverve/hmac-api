// Package hmac provides a Go client for the HMAC Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/hmac?utm_source=go&utm_medium=readme
package hmac
...
const (
	baseURL        = "https://api.apiverve.com/v1/hmac"
	defaultTimeout = 30 * time.Second
)

// Client is the HMAC Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new HMAC Generator API client.
...
// Execute makes a request to the HMAC Generator API with typed parameters.
//
...
//   - secret (required): string - The secret key for HMAC generation
