...
/**
 * Client for the HMAC Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/hmac?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/hmac';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HmacClient] {$message}\n";
        }
    }
}
