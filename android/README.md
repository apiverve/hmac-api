...
```gradle
dependencies {
    implementation 'com.github.apiverve:hmac-api:1.1.13'
}
```
...
```java
import com.apiverve.hmac.HMACGeneratorAPIClient;
import com.apiverve.hmac.APIResponse;
import com.apiverve.hmac.APIException;

// Initialize the client
HMACGeneratorAPIClient client = new HMACGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("message", "Hello World");
    parameters.put("secret", "my-secret-key");
    parameters.put("algorithm", "sha256");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/hmac](https://docs.apiverve.com/ref/hmac)
...
- **Documentation:** [https://docs.apiverve.com/ref/hmac](https://docs.apiverve.com/ref/hmac)
- **Issues:** [GitHub Issues](https://github.com/apiverve/hmac-api/issues)
